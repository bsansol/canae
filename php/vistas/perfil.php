...
<font  face="Arial, Helvetica, Helv" size="15"><b><i >Perfil,</i></b></font>
  <br>
...
$result = mysqli_query($con, "SELECT * FROM usuarios where Id=$id");
        ...
        if (!$result) {
          ...
          if($row['id_tipo']==1){$tipo_usu='Administrador';}

          else{if($row['id_tipo']==3){$tipo_usu='Webmaster';}else{$tipo_usu='Consulta';}}
          ...
          <div style='text-align: center;border: 3px solid black';> 
              ...
              <table align='center';>
                ...
                <tr>
                  ...
                  <td><input type='text' id='id_tipo' name='id_tipo' value='".$tipo_usu."' readonly/></td>
                </tr>
                <tr>
                  <td>NOMBRE:</td>
